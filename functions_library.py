...
def driver_fetch_data(chart_type, type_to_display):
	...
	''' 
	method_mapper_dict = {"circular_biplot": "fetchCircularBiPlotData(type_to_display)", "scatter_plot": "fetchScatterPlotData(type_to_display)",
							"bar_plot": "fetchBarPlotData(type_to_display)", "radar_plot": "fetchRadarPlotData(type_to_display)"}
